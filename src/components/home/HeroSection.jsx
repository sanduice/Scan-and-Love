          ...
          <div className="text-white">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to={createPageUrl('BannerBuilder')}>
                <Button size="lg" className="bg-white hover:bg-gray-100 text-[#8BC34A] px-8 text-lg shadow-lg">
                  Build Your Banner
                </Button>
              </Link>
              <Link to={createPageUrl('Products')}>
                <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white/10 px-8 text-lg">
                  Shop All Products
                </Button>
              </Link>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                ...
                <Link to={createPageUrl('ProductDetail') + `?slug=${selectedProduct}`}>
                  <Button className="bg-white hover:bg-gray-100 text-[#8BC34A] px-8 h-12 text-lg border border-[#8BC34A]">
                    Get Started
                  </Button>
                </Link>
              </div>
