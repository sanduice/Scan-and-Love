...
const contentMap = {
  ...
  'gold-premium-name-badge-1x3': {
      title: '1" x 3" Premium Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/46/46-400.png?v=109',
      description: 'The gold standard for professional identification. Our 1" x 3" Premium Gold Name Badges feature a real brushed gold aluminum surface. This isn\'t just gold-colored plastic; it\'s a textured, metallic finish that radiates quality and trustworthiness.',
      features: ['Real brushed gold aluminum', 'Classic professional size', 'Rich metallic texture', 'Fade and scratch resistant']
  },
  'silver-executive-name-badge-1x3': {
      title: '1" x 3" Silver Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/403/403-400.png?v=109',
      description: 'The pinnacle of professionalism. Our Silver Executive Name Badges feature a polished silver metal frame that encases the badge, protecting the edges and adding a 3D dimensional quality. Designed for C-level executives and board members.',
      features: ['Polished silver metal frame', 'Encased for maximum durability', 'Prestigious 3D appearance', 'Top-tier professional look']
  },
  'gold-executive-name-badge-1x3': {
      title: '1" x 3" Gold Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/405/405-400.png?v=109',
      description: 'The ultimate status symbol. The 1" x 3" Gold Executive Name Badge is framed in polished gold metal, turning a simple ID into a piece of jewelry. It communicates success, high standards, and attention to detail.',
      features: ['Polished gold metal frame', 'Jewelry-quality finish', 'Elite status symbol', 'Secure magnetic backing']
  },
  'wood-name-badge-1x3': {
      title: '1" x 3" Wood Grain Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/121/121-400.png?v=109',
      description: 'Bring a natural, organic touch to your business with our 1" x 3" Wood Grain Name Badges. Perfect for eco-friendly brands, outdoor retailers, coffee shops, and breweries. The realistic wood texture creates a warm and inviting vibe.',
      features: ['Realistic wood grain texture', 'Warm and organic look', 'Perfect for eco-conscious brands', 'Durable plastic core']
  },
  'standard-white-name-badge-1-5x3': {
      title: '1.5" x 3" Standard White Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/35/35-400.png?v=109',
  ...
  'standard-silver-name-badge-2x3': {
      title: '2" x 3" Standard Silver Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/39/39-400.png?v=109',
      description: 'Make a bold statement with our largest silver badge. The 2" x 3" Standard Silver offers maximum visibility and space for complex designs, QR codes, or large typography. When you need to be seen from across the room, this is the badge.',
      features: ['Oversized 2" x 3" dimensions', 'Maximum visibility', 'Great for event passes', 'Metallic silver finish']
  },
  'standard-gold-name-badge-1x3': {
      title: '1" x 3" Standard Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/40/40-400.png?v=109',
  ...
  'standard-gold-name-badge-1-5x3': {
      title: '1.5" x 3" Standard Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/41/41-400.png?v=109',
      description: 'The 1.5" x 3" Standard Gold Name Badge provides a larger golden canvas for your branding. The extra space is perfect for showcasing your logo alongside staff names and titles, all on a background that implies high standards.',
      features: ['Larger 1.5" x 3" format', 'Luxurious gold background', 'High-impact branding', 'Comfortable lightweight design']
  },
  'standard-gold-name-badge-2x3': {
      title: '2" x 3" Standard Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/42/42-400.png?v=109',
      description: 'Our largest gold option, the 2" x 3" Standard Gold Name Badge is unmissable. Perfect for management teams, VIP events, or anyone who deserves extra recognition. The large gold surface commands respect and attention.',
      features: ['Maximum 2" x 3" size', 'Bold gold finish', 'Ultimate visibility', 'Secure and professional']
  },
  'silver-premium-name-badge-1x3': {
      title: '1" x 3" Premium Silver Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/43/43-400.png?v=109',
  ...
  'silver-premium-name-badge-1-5x3': {
      title: '1.5" x 3" Premium Silver Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/44/44-400.png?v=109',
      description: 'The 1.5" x 3" Premium Silver Badge combines the upscale look of brushed aluminum with extra vertical real estate. Ideal for corporate environments where you need to display names, titles, and logos clearly without sacrificing style.',
      features: ['Brushed silver metal finish', 'Extra space for designations', 'Professional corporate look', 'Premium magnetic fastener']
  },
  'silver-premium-name-badge-oval': {
      title: 'Oval Premium Silver Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/45/45-400.png?v=109',
      description: 'Modern elegance defined. The Oval Premium Silver Name Badge features our signature brushed aluminum finish in a contemporary oval shape. It separates your team from the square-badge crowd, offering a unique and high-end aesthetic.',
      features: ['Unique oval shape', 'Real brushed metal surface', 'Contemporary design', 'Durable and lightweight']
  },
  'gold-premium-name-badge-1x3': {
      title: '1" x 3" Premium Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/46/46-400.png?v=109',
  ...
  'gold-premium-name-badge-1-5x3': {
      title: '1.5" x 3" Premium Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/47/47-400.png?v=109',
      description: 'For those who want to shine brighter. The 1.5" x 3" Premium Gold Badge offers a larger brushed gold surface for better visibility. It\'s the perfect choice for management, luxury real estate agents, and high-end hotel staff.',
      features: ['Expanded brushed gold surface', 'High-visibility luxury', 'Perfect for management', 'Durable composite build']
  },
  'gold-premium-name-badge-oval': {
      title: 'Oval Premium Gold Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/48/48-400.png?v=109',
      description: 'Distinction in every detail. The Oval Premium Gold Name Badge combines the luxury of brushed gold with a soft, approachable oval shape. It says "premium service" before you even say a word.',
      features: ['Elegant oval silhouette', 'Brushed gold metal finish', 'Approachable luxury', 'Secure clothing-friendly magnet']
  },
  'wood-name-badge-1x3': {
      title: '1" x 3" Wood Grain Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/121/121-400.png?v=109',
  ...
  'wood-name-badge-1-5x3': {
      title: '1.5" x 3" Wood Grain Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/122/122-400.png?v=109',
      description: 'More space, same natural appeal. The 1.5" x 3" Wood Grain Badge offers extra room for your logo and staff names against a beautiful rustic background. Stands out in corporate sea of metal and plastic.',
      features: ['Larger rustic canvas', 'Natural aesthetic', 'Great for cafes and boutiques', 'Full-color printing ready']
  },
  'wood-name-badge-oval': {
      title: 'Oval Wood Grain Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/123/123-400.png?v=109',
      description: 'The ultimate in friendly, approachable branding. The Oval Wood Grain Name Badge combines a soft shape with a warm texture. It\'s the favorite choice for bakeries, florists, and artisanal shops wanting to make a personal connection.',
      features: ['Soft oval shape', 'Warm wood finish', 'Friendly and inviting', 'Unique brand statement']
  },
  'silver-executive-name-badge-1x3': {
      title: '1" x 3" Silver Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/403/403-400.png?v=109',
  ...
  'silver-executive-name-badge-1-5x3': {
      title: '1.5" x 3" Silver Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/404/404-400.png?v=109',
      description: 'Command authority with the 1.5" x 3" Silver Executive Badge. The larger size, framed in polished silver, makes a powerful statement. Ideal for bank managers, directors, and anyone who leads with confidence.',
      features: ['Large framed design', 'Polished silver border', 'Commanding presence', 'Heavier, substantial feel']
  },
  'gold-executive-name-badge-1x3': {
      title: '1" x 3" Gold Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/405/405-400.png?v=109',
  ...
  'gold-executive-name-badge-1-5x3': {
      title: '1.5" x 3" Gold Executive Name Badge',
      heroImage: 'https://www.namebadge.com/images/products/402/402-400.png?v=109',
      description: 'Unrivaled prestige. The 1.5" x 3" Gold Executive Badge is our most luxurious offering. The substantial gold frame highlights your name and title with unmatched elegance. The choice for five-star hotels, private clubs, and luxury brands.',
      features: ['Luxurious gold frame', 'Maximum size and impact', 'Unmatched elegance', 'The finest badge available']
  }
};
